 ...
 * Original file: C:\\Users\\atsusuke\\AndroidStudioProjects\\WikiCards\\customtabs\\src\\android\\support\\customtabs\\ICustomTabsService.aidl
 */
...
case TRANSACTION_validatePostMessageOrigin:
{
data.enforceInterface(DESCRIPTOR);
android.support.customtabs.ICustomTabsCallback _arg0;
_arg0 = android.support.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
boolean _result = this.validatePostMessageOrigin(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public boolean validatePostMessageOrigin(android.support.customtabs.ICustomTabsCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_validatePostMessageOrigin, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_validatePostMessageOrigin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
...
public boolean validatePostMessageOrigin(android.support.customtabs.ICustomTabsCallback callback) throws android.os.RemoteException;
